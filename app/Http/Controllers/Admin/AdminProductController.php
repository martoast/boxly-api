...
class AdminProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'weight_kg'       => 'nullable|numeric|min:0.01|max:50',
            'length_cm'       => 'nullable|numeric|min:0.1|max:200',
            'width_cm'        => 'nullable|numeric|min:0.1|max:200',
            'height_cm'       => 'nullable|numeric|min:0.1|max:200',
            'status'          => 'nullable|in:draft,active,inactive,sold_out',
